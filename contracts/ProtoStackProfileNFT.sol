...
/**
 * @title ProtoVMProfileNFT
 * @notice Soulbound Profile NFT for ProtoVM users
 * @dev Non-transferable NFT representing a user's profile
 */
contract ProtoVMProfileNFT is ERC721, ERC721URIStorage, ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  event ProfileBurned(address indexed owner, uint256 indexed tokenId, uint256 timestamp);
   ...
   * @param _tokenURI IPFS URI for profile metadata
   */
  function mintFor(address _to, string calldata _tokenURI) external onlyMinter nonReentrant {
